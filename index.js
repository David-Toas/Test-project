...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const eventsData = [
    {
      ...
      status: "Completed",
      description:
        "Join us for a comprehensive exploration of cloud computing innovations and their impact on modern business.",
      speakers: ["Jane Doe", "John Smith", "Sarah Johnson"],
      speakerImages: ["1.jpeg", "2.jpeg", "3.jpeg"],
      attendees: 300,
    },
    {
      id: 2,
      ...
      status: "In Progress",
      description:
        "Discover the latest developments in blockchain technology and its applications across industries.",
      speakers: ["Dr. Peter Smith", "Maria Garcia"],
      speakerImages: ["4.jpeg", "1.jpeg"],
      attendees: 250,
    },
    {
      id: 3,
      ...
      status: "In Progress",
      description:
        "Explore the transformative role of artificial intelligence in healthcare and medical research.",
      speakers: ["Dr. Aisha Malik", "David White"],
      speakerImages: ["2.jpeg", "3.jpeg"],
      attendees: 320,
    },
    {
      id: 4,
      ...
      status: "Completed",
      description:
        "A deep dive into the future of financial technology and innovations in the fintech space.",
    ...
    },
    {
      ...
      status: "In Progress",
      description:
        "Learn how data analytics is shaping business decision-making and strategy.",
      speakers: ["Rachel Moore", "Karen Miller"],
      speakerImages: ["4.jpeg", "3.jpeg"],
      attendees: 310,
    },
    {
      id: 6,
      ...
      status: "In Progress",
      description:
        "A showcase of innovative solutions in sustainable energy for a greener future.",
      speakers: ["Prof. Alan Green", "Linda Scott"],
      speakerImages: ["2.jpeg", "1.jpeg"],
      attendees: 270,
    },
    {
      id: 7,
      ...
      status: "In Progress",
      description:
        "Hands-on workshop on designing user interfaces for Web3 applications.",
      speakers: ["Kevin Adams", "Lisa Brown"],
      speakerImages: ["3.jpeg", "2.jpeg"],
      attendees: 200,
    },
    {
      id: 8,
      ...
      status: "Completed",
      description:
        "Strategies and best practices for ensuring cybersecurity in startup environments.",
      speakers: ["Emily Zhang", "Jason Lee"],
      speakerImages: ["4.jpeg", "2.jpeg"],
      attendees: 230,
    },
    {
      id: 9,
      ...
      status: "In Progress",
      description:
        "Explore innovations and technologies driving the development of smart cities.",
      speakers: ["Dr. Maria Hernandez", "Chris Wilson"],
      speakerImages: ["1.jpeg", "3.jpeg"],
      attendees: 290,
    },
    {
      id: 10,
      ...
      status: "In Progress",
      description:
        "A networking event to meet tech leaders and influencers in an informal setting.",
      speakers: ["Guest Panel"],
      speakerImages: ["4.jpeg"],
      attendees: 150,
    },
  ];
  ...
  function showEventDetails(eventId) {
    ...
    document.getElementById("modalEventDate").textContent = new Date(
      event.date
    ...
    speakersContainer.innerHTML = event.speakers
      .map(
        (speaker, index) => `
      <div class="speaker-avatar flex items-center gap-1 mb-2">
        <img src="${event.speakerImages[index]}" 
             alt="${speaker}" 
             style="width: 20px; height: 20px; border-radius:50%; gap:10px;"
             class="rounded-full"
    ...
    completeBtn.style.display =
      event.status === "In Progress" ? "block" : "none";
  ...
  deleteBtn.addEventListener("click", () => {
    ...
    if (confirmed) {
      const index = eventsData.findIndex(
        (e) => e.id === parseInt(currentEventId)
      );
      if (index !== -1) {
